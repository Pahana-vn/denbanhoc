...
<body>
    <div class="body-wrapper">
                    ...
                    <div class="col-lg-3 d-lg-block d-none">
                        <div class="announcement-call-wrapper">
                            <div class="announcement-call">
                                <a class="announcement-text text-white" href="tel:+1-078-2376">Call: 0969-790-765</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 d-lg-block d-none">
                        <div class="announcement-meta-wrapper d-flex align-items-center justify-content-end">
                            <div class="announcement-meta d-flex align-items-center">
                                ...
                                if(Auth::check()){
                             ?>
                                <a class="announcement-login announcement-text text-white" href="{{route('fe.profile')}}">
                                ...
                                <a class="announcement-login announcement-text text-white" href="{{route('fe.logout')}}">
                                    <svg class="icon icon-user" width="10" height="11" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5 0C3.07227 0 1.5 1.57227 1.5 3.5C1.5 4.70508 2.11523 5.77539 3.04688 6.40625C1.26367 7.17188 0 8.94141 0 11H1C1 8.78516 2.78516 7 5 7C7.21484 7 9 8.78516 9 11H10C10 8.94141 8.73633 7.17188 6.95312 6.40625C7.88477 5.77539 8.5 4.70508 8.5 3.5C8.5 1.57227 6.92773 0 5 0ZM5 1C6.38672 1 7.5 2.11328 7.5 3.5C7.5 4.88672 6.38672 6 5 6C3.61328 6 2.5 4.88672 2.5 3.5C2.5 2.11328 3.61328 1 5 1Z"
                                ...
                                <a class="announcement-login announcement-text text-white" href="{{route('fe.login')}}">
                                    <svg class="icon icon-user" width="10" height="11" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5 0C3.07227 0 1.5 1.57227 1.5 3.5C1.5 4.70508 2.11523 5.77539 3.04688 6.40625C1.26367 7.17188 0 8.94141 0 11H1C1 8.78516 2.78516 7 5 7C7.21484 7 9 8.78516 9 11H10C10 8.94141 8.73633 7.17188 6.95312 6.40625C7.88477 5.77539 8.5 4.70508 8.5 3.5C8.5 1.57227 6.92773 0 5 0ZM5 1C6.38672 1 7.5 2.11328 7.5 3.5C7.5 4.88672 6.38672 6 5 6C3.61328 6 2.5 4.88672 2.5 3.5C2.5 2.11328 3.61328 1 5 1Z"
                                ...
                                <a class="announcement-login announcement-text text-white" href="{{route('fe.register')}}">
                                    <svg class="icon icon-user" width="10" height="11" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5 0C3.07227 0 1.5 1.57227 1.5 3.5C1.5 4.70508 2.11523 5.77539 3.04688 6.40625C1.26367 7.17188 0 8.94141 0 11H1C1 8.78516 2.78516 7 5 7C7.21484 7 9 8.78516 9 11H10C10 8.94141 8.73633 7.17188 6.95312 6.40625C7.88477 5.77539 8.5 4.70508 8.5 3.5C8.5 1.57227 6.92773 0 5 0ZM5 1C6.38672 1 7.5 2.11328 7.5 3.5C7.5 4.88672 6.38672 6 5 6C3.61328 6 2.5 4.88672 2.5 3.5C2.5 2.11328 3.61328 1 5 1Z"
        ...
        <header class="sticky-header border-btm-black header-1">
            <div class="header-bottom">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="{{route('fe.home')}}" class="logo-main">
                                    <img src="{{asset('public/frontend')}}/img/logo-text.png"  loading="lazy" alt="bisum" width="230px" height="60px">
                                </a>
                            </div>
                        </div>
                            ...
                            <nav class="site-navigation">
                                <ul class="main-menu list-unstyled justify-content-center">
                                    ...
                                    <li class="menu-list-item nav-item has-megamenu">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="{{route('fe.product')}}">
                                                Shop
                                            </a>
                                                            ...
                                                            <ul class="megamenu list-unstyled">
                                                                ...
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.category',$item->id)}}">{{$item->name}}</a>
                                                                </li>
                                                                <?php
                                                                    }
                                                                ?>
                                                    ...
                                                    <li class="menu-list-item nav-item-sub">
                                                        ...
                                                        <div class="submenu-transform megamenu-transform">
                                                            <ul class="megamenu list-unstyled">
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">Anti-myopia table lamp Tamayoko</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">Study lamp with folding arm</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">Hakato lamp for children to study</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">Baseus wall-mounted touch lamp</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">Multi-function philippine lamp with 3 lighting modes</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="menu-list-item nav-item-sub">
                                                        ...
                                                        <div class="submenu-transform megamenu-transform">
                                                            <ul class="megamenu list-unstyled">
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">New Year 2024 decorative table lamp</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="">Multi-function table lamp with fan</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">LED eye protection lamp xiaozhu</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">LED desk lamp on Xiaomi monitor</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="{{route('fe.product')}}">Table lamp with remote control</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="menu-list-item nav-item-sub">
                                                        <div
                                                            ...
                                                            <a class="mega-menu-img nav-link-sub nav-text-sub"
                                                                href="{{route('fe.product')}}">
                                                                <img class="menu-img" src="{{asset('public/frontend')}}/img/menuhead/2.jpg"  width="360" height="220" alt="img">
                                    ...
                                    <li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="{{route('fe.aboutus')}}">About-Us</a>
                                        </div>
                                    </li>
                                    <li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="{{route('fe.contact')}}">Contact</a>
                                        </div>
                                    </li>
                                    <li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="{{route('fe.faq')}}">FAQ</a>
                                        </div>
                ...
                <div class="search-wrapper">
                    <div class="container">
                        <form action="{{route('fe.search')}}" class="search-form d-flex align-items-center">
                            ...
                            <div class="search-input mr-4">
                                <input type="text" name="keyword" placeholder="Search your products..." autocomplete="off">
                            </div>
        ...
        <footer class="mt-100 overflow-hidden footer-style-2">
            <div style="background: #f7f7f7" class="footer-top bg-5">
                <div class="container">
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4  class="footer-logo">
                                        <a href="{{route('fe.home')}}"><img src="{{asset('public/frontend')}}/img/logo-text.png"  alt="bisum"></a>
                                    </h4>
            ...
            <div style="background: #00234D" class="footer-bottom bg-5">
                <div  class="container">
                    <div
                        class="footer-bottom-inner d-flex flex-wrap justify-content-md-between justify-content-center align-items-center">
                        <ul class="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                            <li class="footer-menu-item"><a style="color: white" href="about-us.html">Your Site Name</a></li>
                            <li class="footer-menu-item"><a style="color: white" href="about-us.html">Light My Desk</a></li>
                        </ul>
                        <p style="color: white" class="copyright footer-text">©<span class="current-year"></span > Designed By Nhan - Hai - Phuc</p>
                    </div>
                </div>
            </div>
        </footer>
                                            ...
                                            <li class="menu-list-item nav-item-sub">
                                                ...
                                                <div class="submenu-transform">
                                                    ...
                                                    <ul class="megamenu list-unstyled">
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="">Simple Product</a>
                                                        </li>
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="">Variable Product</a>
                                                        </li>
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="">Sale Product</a>
                                                        ...
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="">Featured & On Sale</a>
                                                        </li>
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub" href="">Tab
                                                                Inside</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <li class="menu-list-item nav-item-sub">
                                                ...
                                                <div class="submenu-transform">
                                                    ...
                                                    <ul class="megamenu list-unstyled">
                                                        ...
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="">Product Width Layout</a>
                                                        </li>
                                                        <li class="menu-list-item nav-item-sub">
                                                            <a class="nav-link-sub nav-text-sub"
                                                                href="">Sticky Gallery</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                    ...
                    <ul class="utility-menu list-unstyled">
                        ...
                        <li class="utilty-menu-item">
                            <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img class="flag" src="{{asset('public/frontend')}}/img/flag/usd.jpg" alt="img">
                                <span>USD</span>
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                                ...
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="CAD">
                                        <img class="flag" src="{{asset('public/frontend')}}/img/flag/cad.jpg" alt="img">
                                        <span>CAD</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="EUR">
                                        <img class="flag" src="{{asset('public/frontend')}}/img/flag/eur.jpg" alt="img">
                                        <span>EUR</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="JPY">
                                        <img class="flag" src="{{asset('public/frontend')}}/img/flag/jpy.jpg" alt="img">
                                        <span>JPY</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="GBP">
                                        <img class="flag" src="{{asset('public/frontend')}}/img/flag/gbp.jpg" alt="img">
                                        <span>GBP</span>
                                    </a>
                                </li>
                            </ul>
