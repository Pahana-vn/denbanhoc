            ...
            <div class="col-lg-9 col-md-12 col-12">
                <div class="article-rte">
                    <div class="article-img">
                        <img src="{{asset('public/file/blog')}}/{{$blog->image}}" alt="img">
                    </div>
                    <div class="article-meta">
                        ...
                        <div class="article-card-published text_14 d-flex align-items-center">
                            <span class="article-author d-flex align-items-center">
                                ...
                                <span class="ms-2">{{$blog->name}}</span>
                            </span>
                        ...
                        <div class="comments-area">
                            <div class="d-flex comments-item">
                                <div class="comments-img">
                                    <img src="{{asset('public/frontend')}}/img/people/1.jpg" alt="img">
                                </div>
                                <div class="comments-main">
                                    ...
                                    <div class="comments-replied">
                                        <div class="d-flex comments-item">
                                            <div class="comments-img">
                                                <img src="{{asset('public/frontend')}}/img/people/2.jpg" alt="img">
                                            </div>
                                            <div class="comments-main">
                                                <div class="comments-meta">
                            ...
                            <div class="d-flex comments-item">
                                <div class="comments-img">
                                    <img src="{{asset('public/frontend')}}/img/people/3.jpg" alt="img">
                                </div>
                                <div class="comments-main">
                                    <div class="comments-main-content">
                                        <div class="comments-meta">
                ...
                <div class="filter-drawer blog-sidebar">
                    <div class="filter-widget widget-blogger text-center">
                        ...
                        <div class="blogger-img mb-3">
                            <img class="rounded" src="{{asset('public/file/blog')}}/{{$blog->avatar}}" alt="img" alt="img">
                        </div>
                        <h4 class="blogger-name heading_18 mb-1">{{$blog->nameblogger}}</h4>
                        ...
                        <p class="blogger-desc mb-3">{{$blog->descshort}}</p>
                        ...
                        <div class="accordion-collapse">
                            <ul class="filter-lists list-unstyled mb-0">
                                ...
                                <li class="filter-item">
                                    <a class="filter-label" href="{{route('fe.category',$item->id)}}">
                                        <input type="checkbox" />
                        ...
                        <div class="filter-related">
                            ...
                            <div class="related-item related-item-article d-flex">
                                <div class="related-img-wrapper">
                                    <img class="related-img" src="{{asset('public/file/blog')}}/{{$item->image}}" alt="img">
                                </div>
                                <div class="related-product-info">
                                    <h2 class="related-heading text_14">
                                        <a href="{{route('fe.blog',$item['id'])}}">{{$item->title}}</a>
                                    </h2>
