...
<div class="container-fluid px-4">
    <ol class="breadcrumb mb-4">
        <h1 class="breadcrumb-item active">Add Slider</h1>
        <hr>
    </ol>

    <form action="{{route('be.slideradd')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-5">
                ...
                <a class="btn btn-dark" href="{{route('be.slider')}}"> <i class="fa fa-arrow-circle-left"></i> Back</a>
            </div>
        </div>
    </form>
