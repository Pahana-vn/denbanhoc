    ...
    <div class="slideshow-active activate-slider" data-slick='{
        ...
        "responsive": [
            ...
            "settings": {
                ...
                <?php
                    foreach ($sder as $item) {
                ?>

    <div class="slide-item slide-item-bag position-relative">
        <img class="slide-img d-none d-md-block" src="{{asset('public/file')}}/slider/{{$item->image}}" alt="slide-1">
        <img class="slide-img d-md-none" src="{{asset('public/frontend')}}/img/slideshow/f1-m.jpg" alt="slide-1">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="trusted-badge rounded p-0">
                        <div class="trusted-icon">
                            <img class="icon-trusted" src="{{asset('public/file')}}/trust/{{$item->image}}" alt="icon-1">
                        </div>
                        <div class="trusted-content">
                            <h2 class="heading_18 trusted-heading">{{$item->title}}</h2>
                            <p class="text_16 trusted-subheading trusted-subheading-2">{{$item->desc}}</p>
                        </div>
                    </div>
                </div>
...
<div  class="grid-banner mt-100 overflow-hidden">
    <div class="collection-tab-inner m-0">
        <div  class="container">
            <div  class="grid-container-2">
                <?php
                    foreach ($ads as $item) {
                ?>
                <a style="border: none" class="card grid-item-1 position-relative rounded mt-0 d-flex" href="{{route('fe.product')}}"
                data-aos="fade-right" data-aos-duration="700">
                    {{-- <div style="border: none" class="card"> --}}
                        <img style="width: 100%; height: 100%;  class="banner-img rounded" src="{{asset('public/file')}}/ads/{{$item->image}}" alt="banner-1">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex">
                                <div class="content-box banner-content p-4 ">
                                    <h2 class="heading_34 primary-color">{!!$item->title!!}</h2>
                                    <p class="text_14 mt-2 primary-color">{!!$item->desc!!}</p>
...
<div class="featured-collection mt-100 overflow-hidden">
    <div class="collection-tab-inner">
        <div class="container">
            ...
            <div class="row">
                @foreach ( $featuredtproducts as $item )

                <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                        <div class="product-card-img">
                            <a href="{{route('fe.detail',[khongdau($item->name),$item->id])}}" class="hover-switch">
                                <img class="secondary-img" src="{{asset('public/file')}}/image_secondary/{{$item->image_secondary}}"
                                    alt="product-img">
                                <img class="primary-img" src="{{asset('public/file')}}/image/{{$item->image}}"
                                    alt="product-img">
                            </a>

                            <div class="product-badge">
                                <span class="badge-label badge-percentage rounded">-{{$item->discount}}%</span>
                            </div>

                            <div class="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal-{{$item->id}}" class="action-card action-quickview"
                                ...
                                <button id="themyeuthich" class="action-card action-wishlist">
                                ...
                                <a href="{{route('fe.cart')}}" class="action-card action-addtocart">
                        ...
                        <div class="product-card-details">
                            ...
                            <div class="product-card-price">
                                <span class="card-price-regular">${{$item->price}}</span>
                                <span class="card-price-compare text-decoration-line-through">${{$item->price_old}}</span>
                            </div>
                        </div>
                    </div>
                </div>
 <!-- product quickview start -->
            <div class="modal fade" tabindex="-1" id="quickview-modal-{{$item->id}}">
                                ...
                                <div class="col-lg-6 col-md-12 col-12">
                                    <div class="product-gallery product-gallery-vertical d-flex">
                                        <div class="product-img-large">
                                            ...
                                            @if(count($item->hinhkemtheo) > 0)
                                                @foreach($item->hinhkemtheo as $image)
                                                    <div class="img-large-wrapper">
                                                        <a href="{{asset('public/file/product')}}/{{$image}}" data-fancybox="gallery">
                                                            <img src="{{asset('public/file/product')}}/{{$image}}" alt="img" title="image">
                                                        </a>
                                            ...
                                            @if(count($item->hinhkemtheo) > 0)
                                                @foreach($item->hinhkemtheo as $image)
                                                    <div class="img-thump-wrapper">
                                                        <a href="{{asset('public/file/product')}}/{{$image}}" data-fancybox="gallery">
                                                            <img src="{{asset('public/file/product')}}/{{$image}}" alt="img">
                                                        </a>
                                                    </div>
                                                @endforeach
                                            @else
                                ...
                                <div class="col-lg-6 col-md-12 col-12">
                                    <div class="product-details ps-lg-4">
                                        ...
                                        <div class="product-price-wrapper mb-4">
                                            <span class="product-price regular-price">${{$item->price}}</span>
                                            <del class="product-price compare-price ms-2">${{$item->price_old}}</del>
                                        </div>
                                        <div class="product-sku product-meta mb-1">
                                            <strong class="label">SKU:</strong> {{$item->id}}
                                        </div>
                                        <div class="product-vendor product-meta mb-3">
                                            <strong class="label">Vendor:</strong> LightMyDesk
                                        </div>
                                        ...
                                        <div class="misc d-flex align-items-end justify-content-between mt-4">
                                            <div class="quantity d-flex align-items-center justify-content-between">
                                                <button class="qty-btn dec-qty"><img src="{{asset('public/frontend')}}/img/icon/minus.svg" alt="minus"></button>
                                                <input class="qty-input" type="number" name="soluong" value="1" min="0">
                                                <button class="qty-btn inc-qty"><img src="{{asset('public/frontend')}}/img/icon/plus.svg" alt="plus"></button>
                                            </div>
                                            ...
                                            <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                                <a href="{{route('fe.detail',[khongdau($item->name),$item->id])}}" class="position-relative btn-atc btn-add-to-cart loader">ADD TO CART</a>
                                            ...
                                            <div class="buy-it-now-btn mt-2">
                                                <a href="{{route('fe.checkout')}}" type="submit" class="position-relative btn-atc btn-buyit-now">BUY IT NOW</a>
                                            </div>
...
@endforeach
            ...
            <div class="view-all text-center" data-aos="fade-up" data-aos-duration="700">
                <a class="btn-primary" href="{{route('fe.product')}}">VIEW ALL</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                    <div class="scattered-wrapper">
                        <div class="scattered-content">
                            <img class="scattered-img" src="{{asset('public/file/image')}}/{{$item->image}}" alt="img">
                        </div>
                        <div class="scattered-details">
                            <h2 class="scattered-heading primary-color">{{$item->name}}</h2>
                            <a href="{{route('fe.category',$item->id)}}"
...
<div class="video-section mt-100 overflow-hidden">
    ...
    <div class="overlay-furniture section-spacing"
        style="background: url('{{asset('public/frontend')}}/img/video/video-furniture-44.png') no-repeat fixed bottom center/cover">
                ...
                <div class="col-lg-5 col-md-12 col-12" data-aos="fade-right" data-aos-duration="700">
                    <div class="section-header">
                        ...
                        <p class="section-subheading">
                            The services provided by the genuine manufacturer are smooth and satisfying. Products and goods delivered achieve satisfaction.
                        </p>
                    </div>
                </div>
                            ...
                            <div class="testimonial-item">
                                <div class="testimonial-icon-wrap d-flex align-items-center">
                                    ...
                                    <div class="testimonial-icon-star d-flex align-items-center ms-3">
                                        <img src="{{asset('public/frontend')}}/img/icon/star.png" alt="img">
                                        <img src="{{asset('public/frontend')}}/img/icon/star.png" alt="img">
                                        <img src="{{asset('public/frontend')}}/img/icon/star.png" alt="img">
                                        <img src="{{asset('public/frontend')}}/img/icon/star.png" alt="img">
                                        <img src="{{asset('public/frontend')}}/img/icon/star.png" alt="img">
                                ...
                                <div class="testimonial-reviewer d-flex align-items-center">
                                    <div class="reviewer-img">
                                        <img src="{{asset('public/file/comment')}}/{{$item->image}}" alt="img">
                                    </div>
                                    <div class="reviewer-info ms-4">
                                        <h4 class="reviewer-name heading_18 mb-2 primary-color">
                                            {{$item->name}}
                                        </h4>
                                        <p class="reviewer-desig text_14 m-0">{{$item->pos}}</p>
                                    </div>
                                </div>
                            </div>
                            <?php
...
@foreach ( $ftb as $item )
<img class="single-banner-img" src="{{asset('public/file')}}/footbanner/{{$item->image}}" alt="slide-1">
<div class="content-absolute content-slide">
                ...
                ?>
                    ...
                    <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                        <div class="article-card bg-transparent p-0 shadow-none">
                            <a class="article-card-img-wrapper" href="{{route('fe.blogdetail',[khongdau($item->title),$item->id])}}">
                                <img src="{{asset('public/file/blog')}}/{{$item->image}}" alt="img"
                                    class="article-card-img rounded">

                                <span class="article-tag article-tag-absolute rounded">{{$item->info}}</span>
                            </a>
                            <p class="article-card-published text_12 d-flex align-items-center">
                                <span class="article-date d-flex align-items-center">
                                    ...
                                    <span class="ms-2">{{$item->created_at}}</span>
                                </span>
                            ...
                            <h2 class="article-card-heading heading_18">
                                <a class="heading_18" href="{{route('fe.blogdetail',[khongdau($item->title),$item->id])}}">
                                    {{$item->title}}
                                </a>
                            </h2>
                        </div>
                ...
                ?>
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                        ...
                        <a href="index.html" class="brand-logo d-flex align-items-center justify-content-center">
                            <img src="{{asset('public/file')}}/brandlogo/{{$item->image}}" alt="img">
                        </a>
                    </div>
                    <?php
                    }
