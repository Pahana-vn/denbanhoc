        ...
        <div class="row flex-row-reverse">
            ...
            <div class="col-lg-9 col-md-12 col-12">
                ...
                <div class="collection-product-container">
                        ...
                        <div class="row">
                            <?php
                    foreach ($loadsp as $item)
                        {
                    ?>
                            <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="{{route('fe.detail',[khongdau($item->name),$item->id])}}">
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <div class="product-card-price">
                                            ...
                                            <span
                                                class="card-price-compare text-decoration-line-through">${{$item->price_old}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
                            <div style="margin: 50px 0px 0px 0px;"  class="col-12 pb-1">
                                {{$loadsp->links()}}
                            </div>
                        </div>
            ...
            <div class="col-lg-3 col-md-12 col-12">
                <div class="collection-filter filter-drawer">
                        ...
                        <div class="filter-related">
                            <div class="related-item d-flex">
                                <div class="related-img-wrapper">
                                    <img class="related-img" src="{{asset('public/frontend')}}/img/products/furniture/21.jpg"
                                        alt="img">
                                </div>
                            ...
                            <div class="related-item d-flex">
                                <div class="related-img-wrapper">
                                    <img class="related-img" src="{{asset('public/frontend')}}/img/products/furniture/22.jpg"
                                        alt="img">
                                </div>
                                <div class="related-product-info">
                                    <h2 class="related-heading heading_18">
                            ...
                            <div class="related-item d-flex">
                                <div class="related-img-wrapper">
                                    <img class="related-img" src="{{asset('public/frontend')}}/img/products/furniture/23.jpg"
                                        alt="img">
                                </div>
                                <div class="related-product-info">
                                    <h2 class="related-heading heading_18">
                    ...
                    <div class="filter-widget">
                        <a href="product.html">
                            <img class="rounded" src="{{asset('public/frontend')}}/img/banner/collection.jpg" alt="img">
                        </a>
                    </div>
                </div>
            </div>
