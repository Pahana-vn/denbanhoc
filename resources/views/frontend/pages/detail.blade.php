        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-12">
                <div class="product-gallery product-gallery-vertical d-flex">
                    <div class="product-img-large">
                        ...
                        @if(isset($hinhkemtheo) && is_array($hinhkemtheo) && count($hinhkemtheo) > 0)
                        @foreach($hinhkemtheo as $image)
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="product-details ps-lg-4">
                    ...
                    <h2 class="product-title mb-3">{{$detail->name}}</h2>
                    ...
                    <div class="product-price-wrapper mb-4">
                        <span class="product-price regular-price">{{$detail->price}}</span>
                        <del class="product-price compare-price ms-2">{{$detail->price_old}}</del>
                    </div>
                    <div class="product-sku product-meta mb-1">
                        <strong class="label">SKU:</strong> {{$detail->id}}
                    </div>
                    ...
                    <div class="misc d-flex align-items-end justify-content-between mt-4">
                        <div class="quantity d-flex align-items-center justify-content-between">
                            ...
                            <input type="text" class="qty-input" type="number" name="soluong" value="1">
                        ...
                        <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                            <button id="themgiohang" class="position-relative btn-atc btn-add-to-cart loader">ADD TO CART</button>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-12 col-12">
                        <div class="desc-content">
                            <h4 class="heading_18 mb-3">Details and instructions for use</h4>
                            <p class="text_16 mb-4">{{$detail->content}}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-12 col-12">
                        ...
                        <div class="desc-img">
                            <img style="width: 400px; height: 400px;" src="{{asset('public/file')}}/image_secondary/{{$detail->image_secondary}}" alt="img">
                        </div>

                    </div>
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="desc-content mt-4">
                            <p class="text_16">{{$detail->desc}}</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="featured-collection-section mt-100 home-section overflow-hidden">
    <div class="container">
        <div class="section-header">
            <h2 style="text-align: center" class="section-heading">You may also like</h2>
        </div>
            ...
            <div class="product-card">
                <div class="product-card-img">
                    ...
                    {{-- <div class="product-card-action product-card-action-2">
                        <a id="quickview-modal-{{$item->id}}" href="#quickview-modal" class="quickview-btn btn-primary"
                            data-bs-toggle="modal">QUICKVIEW</a>
                        <a href="{{route('fe.detail',[khongdau($item->name),$item->id])}}" class="addtocart-btn btn-primary">ADD TO CART</a>
                    </div> --}}


                    <a href="{{route('fe.product')}}" class="wishlist-btn card-wishlist">
                ...
                <div class="product-card-details text-center">
                    <h3 class="product-card-title"><a href="collection-left-sidebar.html">{{$item->name}}</a>
                    </h3>
